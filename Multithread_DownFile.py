...
# import requests
#
# downfileurl='https://bigota.d.miui.com/V12.5.10.0.RJBCNXM/miui_UMI_V12.5.10.0.RJBCNXM_48012c540b_11.0.zip'
#
# headers={'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.69 Safari/537.36'}
#
# res=requests.get(downfileurl,headers=headers,timeout=5,verify=False)
#
...
if __name__=="__main__":
    ...
    filename_input=input('请输入你要下载的文件链接：')
    if filename_input:
        url=filename_input
        file_name = url.split('/')[-1]
    else:
        url = 'https://bigota.d.miui.com/V12.5.10.0.RJBCNXM/miui_UMI_V12.5.10.0.RJBCNXM_48012c540b_11.0.zip'
        file_name=url.split('/')[-1]
    print(file_name)
    # 开始下载文件
